...
def build_manifest_schema() -> dict[str, Any]:
    required_columns = [
        ...
        {"name": "prompt_text", "type": "string", "description": "Teacher prompt used for this image."},
        {
            "name": "box_threshold",
            "type": "number",
            "description": "GroundingDINO box threshold recorded for reproducibility.",
        },
        {
            "name": "text_threshold",
            "type": "number",
            "description": "GroundingDINO text threshold recorded for reproducibility.",
        },
        {
            "name": "mask_threshold",
            "type": "number",
            "description": "SAM2 mask threshold recorded for reproducibility.",
        },
        {
