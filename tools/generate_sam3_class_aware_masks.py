...
def _load_yaml_helpers() -> tuple[Any, Any, Any, Any, Any]:
    from generate_sam3_primitive_pilots import (
        as_float,
        as_int,
        config_path,
        load_simple_yaml,
    ...
    return as_float, as_int, config_path, load_simple_yaml, require_mapping, split_sequence


def load_config(path: Path, project_root: Path) -> Config:
    as_float, as_int, config_path, load_simple_yaml, require_mapping, split_sequence = _load_yaml_helpers()
